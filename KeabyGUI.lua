...
makeSlider(pnl2,"Max wait time",0.01,5.0,0.19,function(v) instant2x.Settings.MaxWaitTim=v end)
makeSlider(pnl2,"Fallback Time",0.01,5.0,0.19,function(v) instant2x.Settings.RetryDelay=v end)
