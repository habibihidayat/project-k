...
makeSlider(pnl1,"Retry Delay",0.01,1.5,0.19,function(v) instant.Settings.RetryDelay=v end)
makeSlider(pnl1,"Fallback Time",0.01,1.5,0.19,function(v) instant.Settings.FallbackTime=v end)
