...
makeSlider(pnl1, "Perfect Release Delay", 0.001, 4.0, 0.001, function(v) 
...
makeSlider(pnl4,"Perfect Charge Time",0.001,4.000,0.998,function(v) instant2.Settings.PerfectChargeTime=v end)
makeSlider(pnl4,"Perfect Release Delay",0.0001,4.000,0.0005,function(v) instant2.Settings.PerfectReleaseDelay=v end)
makeSlider(pnl4,"Perfect Power",0.001,4.000,0.987,function(v) instant2.Settings.PerfectPower=v end)
